...
print("Using moondream-0.5b model with moondream 0.0.6 Python API")
# Start timer
...
image = Image.open("../images/Alan_WaLI_and_Dave.jpg")
...
# Ask quetions about the image
print("In this picture there is a man and two robots.  Describe the robots.")
query_start_time = time.time()
answer = model.query(encoded_image, "In this picture there is a man and two robots.  Describe the robots.")["answer"]
query_done_time = time.time()
print(f"Query Time: {query_done_time - query_start_time:.2f} seconds")
print(answer)
