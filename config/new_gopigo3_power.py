#!/usr/bin/env python3
#
# This code is for power management on a Raspberry Pi 4 or 5 with GoPiGo3.
...
try:
  ...
  try:
    ...
    print("gpiod cannot determine proper 'Chip' value, exiting")
    exit(1)
...
gpg_pwr_button.request(consumer="new_gopigo3_power.py", type=gpiod.LINE_REQ_DIR_IN, flags=gpiod.LINE_REQ_FLAG_BIAS_PULL_DOWN)


# set GPIO23 to output
# GPIO.setup(23, GPIO.OUT)
rpi_alive.request(consumer="new_gopigo3_power.py", type=gpiod.LINE_REQ_DIR_OUT)
