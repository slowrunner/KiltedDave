...
#
# Serialize data values to /home/ubuntu/KiltedDave/rosbotData.json
#
# Methods:
...
def saveData(dataname, datavalue, logit=False):
    ...
    with DataLock:         # prevents two different saveData() at same time
        ...
        try:
            ...
            with open('/home/ubuntu/KiltedDave/rosbotData.json', 'w') as outfile:
...
def getData(dataname=None):
    ...
    try:
        with open('/home/ubuntu/KiltedDave/rosbotData.json', 'r') as infile:
